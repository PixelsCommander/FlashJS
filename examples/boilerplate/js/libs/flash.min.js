...
Function.prototype.bind === undefined && (Function.prototype.bind = function () {
    ...
    var b = function (a, b, c, d) {
        this.init(), a !== undefined && this.setImage(a, b, c), d !== undefined && this.setStage(d)
    }, c = b.prototype;
    c.cacheCanvas = null, c.id = -1, c.name = null, c.parent = null, c.zindexCache = 0, c.x = 0, c.y = 0, c.regX = 0, c.regY = 0, c.width = 0, c.height = 0, c._width = 0, c._height = 0, c.scaleX = 1, c.scaleY = 1, c.rotation = 0, c.alpha = 1, c._matrix = null, c.visible = !0, c.mouseEnabled = !0, c.snapToPixel = !1, c.handlers = [], c.onPress = null, c.onClick = null, c.onMousOver = null, c.onMouseOut = null, c.onTick = null, c.init = function () {
        ...
        this._stage !== undefined && (a === undefined && (a = this.zindexCache), this._stage.maxzindex = Math.max(this._stage.maxzindex, a))
    ...
    var b = function (b, c, d) {
        ...
        }, this.onUpClosure = this.onUpClosure.bind(this), a.flash.initTouch(this), this.childs = []
    ...
    c._addChild = c.addChild, c.addChild = function (a) {
        ...
        this.scale = this.canvas.scale = f, e >= 1.77 && e <= 1.79 ? (this.canvas.style.width = a + "px", this.canvas.style.height = b + "px") : (this.canvas.style.width = this.baseWidth * f + "px", this.canvas.style.height = this.baseHeight * f + "px");
    ...
    p = b.prototype, p.data = {}, p._frameWidth = 0, p._frameHeight = 0, p._totalFrames = 0, p.fillFramesFromSpritesheet = function () {
        ...
        for (var a = 0; a < this.frames.length; a++) {
            var b = this.getAnimationByFrameNumber(a);
            b !== undefined && b.makeFlip ? this.flippedFrames.push(this.getFlippedFrame(this.frames[a])) : this.flippedFrames.push(undefined)
        }
    }, p.getFlippedFrame = function (a) {
        var b = document.createElement("canvas");
        b.width = this._frameWidth, b.height = this._frameHeight;
        var c = b.getContext("2d"), d = document.createElement("canvas");
        d.width = this._frameWidth, d.height = this._frameHeight;
        var e = d.getContext("2d");
        return c.save(), c.scale(-1, 1), c.drawImage(a, -this._frameWidth, 0), e.drawImage(b, 0, 0), c.restore(), d
    ...
    a.DeviceMotionEvent != undefined && (a.flash.accelerometer = a.flash.accelerometer || {}, a.flash.accelerometer.noiseBarrier = .2, a.addEventListener("devicemotion", function (b) {
    ...
    b.checkLoaderType = function (a, b) {
        ...
        if (c === "jpg" || c === "png" || c === "gif")return!0
    }, p = b.prototype = new DisplayObject, a.flash.cloneToNamespaces(b, "ImageLoader")
}(window), function (a) {
    var b = function (b, c, d, e, f) {
    ...
    p = b.prototype, p.loadSpritesheet = function () {
        ...
        var b = a + "", c = "", d = this.options.fileNameNumbers || 4, e = d - b.length;
    ...
    p = b.prototype, p.getFromJSON = function (a, b) {
        ...
        if (a.constructor == Array)for (var c = 0; c < a.length; c++)this.add(a[c]); else this.toProceed++, this.newItemsCount++, this.items[a.id] = a, this.items[a.id].url = this.fixURL(this.items[a.id].url), this.items[a.id].callback = this.items[a.id].callback
    }, p.fixURL = function (a) {
